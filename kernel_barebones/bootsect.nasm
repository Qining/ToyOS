...
load_kernel:
	...
	mov bx, KERNEL_ADDR
	mov dh, 10 ; this goes to al in disk_load.
...
%include "../boot_sector_tutorial/boot_sect_disk_load.nasm"
%include "../boot_sector_tutorial/boot_sect_print_hex.nasm"
...
%include "../32_bit_protected_mode_tutorial/32bit-switch.nasm"
; 32bit-switch.nasm doesn't include gdt, so we need to include it here.
%include "../32_bit_protected_mode_tutorial/32bit-gdt.nasm"
%include "../32_bit_protected_mode_tutorial/32bit-print.nasm"
